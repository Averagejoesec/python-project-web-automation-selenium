...
class App:
    def __init__(self, root):
        ...
        tk.Label(self.login_frame, text="Username").grid(row=0, column=0, stick="w")
        self.entry_username = tk.Entry(self.login_frame)
        self.entry_username.grid(row=0, column=1, sticky="ew")
        
        tk.Label(self.login_frame, text="Password").grid(row=1, column=0, stick="w")
        ...
        tk.Button(self.button_frame, text="Close Browswer", command=self.close_browser).grid(row=0, column=1, padx=5)
